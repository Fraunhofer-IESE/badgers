...
**Files:**
- Create: `benchmarks/results/run_baseline_0_0_13_<timestamp>.json` (auto-generated by CLI)
- Create: `benchmarks/baselines/v0.0.13.json` (via `baseline save`)

**Interfaces:**
- Consumes: all registered `GeneratorBenchmark` instances (from Tasks 2-5)
- Produces: baseline JSON file at `benchmarks/baselines/v0.0.13.json`
...
```bash
git add benchmarks/baselines/v0.0.13.json
git commit -m "bench: add v0.0.13 baseline with all tabular generators"
```
